...
public class NpsSurveyWindowActivator : DialogActivatorBase<NpsSurveyWindow>, INpsSurveyWindowActivator
{
    public override string WindowTitle => Localizer.Get("NpsSurvey_Title");

    public NpsSurveyWindowActivator(
        ILogger logger,
