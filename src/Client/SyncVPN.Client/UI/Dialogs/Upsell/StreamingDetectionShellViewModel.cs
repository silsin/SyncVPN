...
public partial class StreamingDetectionShellViewModel : ShellViewModelBase<IStreamingDetectionWindowActivator>
{
    private readonly IAccountUpgradeUrlLauncher _accountUpgradeUrlLauncher;

    public StreamingDetectionShellViewModel(
        IStreamingDetectionWindowActivator windowActivator,
