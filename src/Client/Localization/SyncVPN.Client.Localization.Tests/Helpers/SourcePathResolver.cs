...
namespace SyncVPN.Client.Localization.Tests.Helpers;
...
public static class SourcePathResolver
{
    ...
    public static string LocalizationStringsRoot => 
        Path.Combine(SourceRoot, "Client", "Localization", "SyncVPN.Client.Localization", "Strings");
    ...
    private static string FindSolutionRoot()
    {
        ...
        while (dir != null)
        {
            if (File.Exists(Path.Combine(dir, "SyncVPN.slnx")))
            {
                return dir;
            }
