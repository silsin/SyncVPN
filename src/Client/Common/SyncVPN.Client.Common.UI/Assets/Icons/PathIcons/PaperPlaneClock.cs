...
public class PaperPlaneClock : CustomPathIcon
{
    protected override string IconGeometry16 { get; }
        = "m7.539 9.363-.072-.115.39-.39c.28-.385.62-.725 1.007-1.005L13.35 3.37l-1.223 3.673c.338.047.663.131.971.249l1.874-5.628a.505.505 0 0 0-.639-.638L1.345 5.365a.503.503 0 0 0-.106.905l5.026 3.134c.13.08.24.19.322.32l.515.823c.09-.42.24-.817.438-1.184ZM2.661 5.979l10.01-3.343-5.907 5.9L2.66 5.98Z M11.5 15a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7Zm.5-5.5a.5.5 0 0 0-1 0v2.207l1.146 1.147a.5.5 0 0 0 .708-.708L12 11.293V9.5Z";
