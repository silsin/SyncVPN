...
public class TrashCrossFilled : CustomPathIcon
{
    protected override string IconGeometry16 { get; }
        = "M6.053 1.276A.5.5 0 0 1 6.5 1h3a.5.5 0 0 1 .447.276L10.81 3H14a.5.5 0 0 1 0 1h-1.043l-.878 10.087a1 1 0 0 1-.996.913H4.917a1 1 0 0 1-.996-.913L3.043 4H2a.5.5 0 0 1 0-1h3.191l.862-1.724ZM9.19 2l.5 1H6.309l.5-1h2.382ZM5.646 6.646a.5.5 0 0 1 .708 0L8 8.293l1.646-1.647a.5.5 0 0 1 .708.708L8.707 9l1.647 1.646a.5.5 0 0 1-.708.708L8 9.707l-1.646 1.647a.5.5 0 0 1-.708-.708L7.293 9 5.646 7.354a.5.5 0 0 1 0-.708Z";

    protected override string IconGeometry20 { get; }
        = "M7.566 1.595a.625.625 0 0 1 .559-.345h3.75c.237 0 .453.134.559.345l1.077 2.155H17.5a.625.625 0 1 1 0 1.25h-1.304l-1.097 12.608a1.25 1.25 0 0 1-1.245 1.142H6.146a1.25 1.25 0 0 1-1.245-1.142L3.804 5H2.5a.625.625 0 1 1 0-1.25h3.989l1.077-2.155Zm3.923.905.625 1.25H7.886l.625-1.25h2.978Zm-4.43 5.808a.625.625 0 0 1 .883 0L10 10.366l2.058-2.058a.625.625 0 1 1 .884.884l-2.058 2.058 2.058 2.058a.625.625 0 1 1-.884.884L10 12.134l-2.058 2.058a.625.625 0 1 1-.884-.884l2.058-2.058-2.058-2.058a.625.625 0 0 1 0-.884Z"; 
