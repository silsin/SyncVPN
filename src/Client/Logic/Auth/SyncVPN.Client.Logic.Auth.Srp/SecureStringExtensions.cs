...
namespace SyncVPN.Client.Logic.Auth.Srp;

public static class SecureStringExtensions
{
    public static unsafe DisposableBytes ToDisposableBytes(this SecureString str)
    {
        ...
        return new DisposableBytes
        {
            Data = nativeUtf8,
            Length = nativeUtf8Length,
            Capacity = nativeUtf8Length,
        };
    }
}