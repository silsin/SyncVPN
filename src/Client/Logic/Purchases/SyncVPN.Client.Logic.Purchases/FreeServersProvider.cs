...
public class FreeServersProvider : IFreeServersProvider
{
    private readonly ISyncVpnApiClient _apiClient;

    public FreeServersProvider(ISyncVpnApiClient apiClient)
    {
        _apiClient = apiClient;
    }

    public Task<ApiResponseResult<ServerListResponse>> GetFreeServersAsync(CancellationToken cancellationToken = default)
    {
