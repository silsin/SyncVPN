...
using ILogger = SyncVPN.Logging.Contracts.ILogger;

namespace SyncVPN.ProcessCommunication.Server;
...
public class GrpcServer : IGrpcServer
{
    ...
    {
        return $"SyncVPN-{HashGenerator.GenerateRandomString(32)}";
    }
