...
using SyncVPN.Core.Servers;
using PhysicalServer = SyncVPN.Core.Servers.Models.PhysicalServer;
using Server = SyncVPN.Core.Servers.Models.Server;

namespace SyncVPN.Core.Tests.Servers
{
    [TestClass]
