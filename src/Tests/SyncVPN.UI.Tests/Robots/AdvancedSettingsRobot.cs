...
public class AdvancedSettingsRobot
{
    ...
    private string? WireguardDnsAddress => NetworkUtils.GetDnsAddresses("SyncVPN").FirstOrDefault();
    private string? OpenVpnDnsAddress => NetworkUtils.GetDnsAddresses("SyncVPN TUN").FirstOrDefault();
