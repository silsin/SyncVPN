...
using SyncVPN.UI.Tests.ApiClient.Contracts;

namespace SyncVPN.UI.Tests.ApiClient.Prod;
...
public class ProdTestApiClient
{
    ...
    private HttpRequestMessage GetUnauthorizedRequestMessage(HttpMethod method, string requestUri)
    {
        ...
        request.Headers.Add("User-Agent", "SyncVPN/2.4.3 (Microsoft Windows NT 10.0.19045.0)");
