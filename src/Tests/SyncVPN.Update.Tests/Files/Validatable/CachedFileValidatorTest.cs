...
namespace SyncVPN.Update.Tests.Files.Validatable
{
    ...
    public class CachedFileValidatorTest
    {
        ...
        {
            const string filename = "TestData\\SyncVPN_win_v1.0.0.exe";
        ...
        {
            const string filename = "TestData\\SyncVPN_win_v1.5.2.exe";
        ...
        public async Task Valid_ShouldCall_Origin_WenFilename_HasChanged()
        {
            const string filename = "TestData\\SyncVPN_win_v1.0.0.exe";
            const string checkSum = "b1dc9dbd738a5f98b7f5e920ffcc5ba9db42517e";
            const string changedFilename = "TestData\\SyncVPN_win_v1.5.0.exe";
        ...
        public async Task Valid_ShouldCall_Origin_WenFileLastWriteTime_HasChanged()
        {
            ...
            string filename = Path.Combine(updatesPath, "SyncVPN_win_v1.5.1.exe");
        ...
        public async Task Valid_ShouldCall_Origin_WenFileLength_HasChanged()
        {
            ...
            CopyFile("windows-releases.json", updatesPath, "SyncVPN_win_v1.5.1.exe");
