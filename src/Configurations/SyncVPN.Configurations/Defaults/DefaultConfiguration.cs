...
public static class DefaultConfiguration
{
    ...
    private static readonly Lazy<string> _localAppDataProtonVpnPath = new(() => Path.Combine(_localAppDataPath.Value, "Proton", "SyncVPN"));

    /// <returns>C:\Users\{user}\AppData\Local\Proton\SyncVPN\Storage</returns>
