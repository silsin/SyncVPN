...
public interface ISplitTunnelingIpsCountDimensionMapper : IDimensionMapper<int>
{
    string Map(SplitTunnelingMode splitTunnelingMode, List<SplitTunnelingIpAddress>? standardIps, List<SplitTunnelingIpAddress>? inverseIps);
}
