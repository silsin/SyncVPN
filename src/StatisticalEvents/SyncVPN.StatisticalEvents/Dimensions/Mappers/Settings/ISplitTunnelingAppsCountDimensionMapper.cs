...
public interface ISplitTunnelingAppsCountDimensionMapper : IDimensionMapper<int>
{
    string Map(SplitTunnelingMode splitTunnelingMode, List<SplitTunnelingApp>? standardApps, List<SplitTunnelingApp>? inverseApps);
}
