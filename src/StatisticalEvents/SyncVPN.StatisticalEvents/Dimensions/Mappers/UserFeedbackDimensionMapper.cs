...
public class UserFeedbackDimensionMapper : DimensionMapperBase, IUserFeedbackDimensionMapper
{
    ...
    public string Map(UserFeedback? feedback)
    {
        return feedback switch
        {
            UserFeedback.Positive => POSITIVE,
            UserFeedback.Negative => NEGATIVE,
            UserFeedback.Ignored => IGNORE,
            _ => UNKNOWN
        };
    }
}