...
2. Sign `bin\Release\x64\SyncVPN.CalloutDriver\SyncVPN.CalloutDriver.sys` with your organization's EV code-signing certificate and overwrite the unsigned file.
...
4. Sign `SyncVPN.CalloutDriver.x64.cab` with your organization's EV code-signing certificate.
...
6. After Microsoft returns the signed package, download the updated files and replace:
   - `Setup\Native\x64\syncvpn.calloutdriver.cat`
