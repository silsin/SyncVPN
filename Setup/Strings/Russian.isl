[CustomMessages]
InstallerTitle=SyncVPN готов к установке
...
ProtonPassDescription=Зашифрованный менеджер паролей, который защищает вашу личную информацию в Интернете.
InstallingWebview2Runtime=Установка Web View 2 runtime...
CreateDesktopShortcuts=Создать ярлык(и) на рабочем столе